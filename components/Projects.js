...
export default function Projects() {
  ...
  const projects = [
    ...
    // },
    {
      ...
      title: "Muain CRM & Services System",
      company: "Sahalat LLC",
      description: "Enterprise CRM and service management system built with Laravel, featuring workflow automation, ticket management, real-time notifications, and Bank Muscat payment integration.",
      technologies: ["Laravel", "MySQL", "AJAX", "WebSockets", "Payment Gateway"],
      features: [
